...
export const mockAssets = [
  { id: "1", placaOuTag: "ABC1D23", assetType: ASSET_TYPES.CAMINHAO, cell: "Logística", responsavel: "Noelio" },
  { id: "2", placaOuTag: "XYZ9F88", assetType: ASSET_TYPES.VAN, cell: "Logística", responsavel: "Noelio" },
  { id: "3", placaOuTag: "ESC-336-014", assetType: ASSET_TYPES.PESADO, cell: "Gestão de Ativos", responsavel: "Bianca" },
  { id: "4", placaOuTag: "TRT-D6T-007", assetType: ASSET_TYPES.PESADO, cell: "Gestão de Ativos", responsavel: "Rudkeler" },
  { id: "5", placaOuTag: "TQ-CONT-002", assetType: ASSET_TYPES.CONTAINER_TANQUE, cell: "Gestão de Ativos", responsavel: "João Pedro" },
];
...
export const mockDocumentsByAssetId = {
  "1": [
    ...
    // ANTT/RNTRC, Licenciamento, Certificado de Inspeção, CIV, Seguro: faltantes de propósito
  ],
  "2": [
  ...
  "4": [
    // tudo faltante de propósito (ativo novo, recém-cadastrado)
  ],
  "5": [
